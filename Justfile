...
NAME_DIRECTORY_PY_SOURCES := 'spotfetch'
...
FILE_BUILD_QRC_I18N_JSON := DIRECTORY_BUILD_QRC_I18N + '/spotfetch.json'
...
FILE_BUILD_TRANSLATIONS_JSON := DIRECTORY_BUILD_TRANSLATIONS + '/spotfetch.json'
